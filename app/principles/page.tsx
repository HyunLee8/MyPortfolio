    ...
    <div className="min-h-screen p-4 sm:p-8 bg-white">
      ...
      <div className="max-w-6xl mx-auto py-16 sm:py-20">
        <div className="mb-12 sm:mb-20">
          <h1 className="text-4xl sm:text-6xl font-light text-gray-900 mb-4 tracking-wide">Principles</h1>
        ...
        <div className="group">
            <a 
              href="https://open.spotify.com/playlist/0RzkIyS7OHaEBcpDYZ8Wak" 
              target="_blank" 
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">I Always Wanna Die (Sometimes)</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium">The 1975</p>
          ...
          <div className="group">
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Everlasting Love</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium">LEEHEESANG</p>
              <div className="pt-2 border-t border-gray-200">
        ...
        <div className="group">
            <a 
              href="https://open.spotify.com/playlist/0RzkIyS7OHaEBcpDYZ8Wak6" 
              target="_blank" 
              rel="noopener noreferrer"
              className="block overflow-hidden border border-gray-200 shadow-lg mb-6"
            >
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Stars burn out</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium">Cykim</p>
              <div className="pt-2 border-t border-gray-200">
          ...
          <div className="group">
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">About You</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium">The 1975</p>
              <div className="pt-2 border-t border-gray-200">
          ...
          <div className="group">
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">여전히 아름다운지</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium"><span className="text-red-500">TOY</span> | Yoo Hee Yeol</p>
              <div className="pt-2 border-t border-gray-200">
          ...
          <div className="group">
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Lily of the Valley</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium">DANIEL</p>
              <div className="pt-2 border-t border-gray-200">
          ...
          <div className="group">
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Nothings Gonna Hurt You Baby</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium">Cigarettes After Sex</p>
              <div className="pt-2 border-t border-gray-200">
          ...
          <div className="group">
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Love Shine</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium">LEEHEESANG</p>
              <div className="pt-2 border-t border-gray-200">
          ...
          <div className="group">
            ...
            <div className="space-y-3">
              <div className="flex items-baseline justify-between">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">No. 1 Party Anthem</h2>
              </div>
              <p className="text-base sm:text-lg text-gray-700 font-medium">Arctic Monkeys</p>
              <div className="pt-2 border-t border-gray-200">
