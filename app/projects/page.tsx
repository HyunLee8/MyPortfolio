  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 bg-white">
      ...
      <div className="max-w-7xl mx-auto py-16 sm:py-20 flex flex-col gap-20 sm:gap-32">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-start lg:items-center group">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-start group">
          <div className="flex flex-col space-y-1 w-full lg:w-[520px]">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-2 sm:space-y-3 border-l-2 border-gray-200 pl-4 sm:pl-5 group-hover:border-gray-900 transition-colors duration-300">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-900 uppercase tracking-wide">Mathematical Framework</h3>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-[15px]">
              ...
              <div className="space-y-2 sm:space-y-3 border-l-2 border-gray-200 pl-4 sm:pl-5 group-hover:border-gray-900 transition-colors duration-300">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-900 uppercase tracking-wide">Numerical Stability</h3>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-[15px]">
              ...
              <div className="space-y-2 sm:space-y-3 border-l-2 border-gray-200 pl-4 sm:pl-5 group-hover:border-gray-900 transition-colors duration-300">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-900 uppercase tracking-wide">Asynchronous Processing</h3>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-[15px]">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-start group">
          <div className="flex flex-col space-y-1 w-full lg:w-[420px]">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-2 sm:space-y-3 border-l-2 border-gray-200 pl-4 sm:pl-5 group-hover:border-gray-900 transition-colors duration-300">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-900 uppercase tracking-wide">Architecture Design</h3>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-[15px]">
              ...
              <div className="space-y-2 sm:space-y-3 border-l-2 border-gray-200 pl-4 sm:pl-5 group-hover:border-gray-900 transition-colors duration-300">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-900 uppercase tracking-wide">Threshold Optimization</h3>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-[15px]">
          ...
          <Link href="https://arxiv.org/pdf/1909.09586" className="w-full lg:flex-1 flex flex-col sm:flex-row gap-4 sm:gap-5">
            <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm bg-white w-full sm:max-w-100">
              <img 
                src="/LSTM1.png" 
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm bg-white w-full sm:max-w-90">
              <img 
                src="/LSTM2.png" 
